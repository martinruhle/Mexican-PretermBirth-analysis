...
working_directory <- "C:/Users/marti/Documents/Datos_mexicanos/"
setwd(working_directory)

# Load datasets
complete_data <- read_csv("genus_rel_filtered_2025-05-25.csv")
metadata_long <- read_csv("metadata_eugenia_long.csv")
participant_data <- read_csv("participant_data_clean.csv")
...
# Cured list based on Salter et al. 2014, Eisenhofer et al. 2019
contaminant_genera <- c(
  # Confirmados por Salter et al. 2014 (Table 1)
  "Methylobacterium", "Methylorubrum",  # Sinónimos taxonómicos
  "Ralstonia", "Mesorhizobium", "Microbacterium",
  "Bradyrhizobium", "Sphingomonas", "Pseudomonas", "Acinetobacter",
  # No bacteriano
  "o__Chloroplast"
)
